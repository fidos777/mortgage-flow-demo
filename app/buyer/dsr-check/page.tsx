...
export default function DSRQuickCheckPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      {/* Back Link */}
      <Link href="/buyer" className="inline-flex items-center gap-2 text-slate-600 hover:text-slate-800 mb-6">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white mb-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Kalkulator DSR</h1>
            <p className="text-blue-100 text-sm">Debt Service Ratio Quick Check</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-4 rounded-xl font-semibold hover:from-blue-600 hover:to-blue-700 transition-all"
        >
          Kira DSR
        </button>
      </div>
