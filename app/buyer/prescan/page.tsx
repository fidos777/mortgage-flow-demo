      ...
      case 1: // Authorization - Dual Verification
        return (
          <div>
            ...
            {/* Consent Checkbox - PRD Section 15.3 */}
              ...
              <div className="mb-4">
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full border-2 border-slate-200 rounded-xl p-4 text-left hover:border-orange-300 transition-all flex items-center gap-4"
                  >
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 border-2 border-slate-200 rounded-xl px-4 py-3 focus:border-orange-500 focus:outline-none"
                      disabled={otpSent}
                    />
                    <button
                      onClick={sendOtp}
                    ...
                    <div className="flex gap-2 justify-center">
                      {otp.map((digit, i) => (
                        <input
                          ...
                          className="w-12 h-14 border-2 border-slate-200 rounded-xl text-center text-xl font-bold focus:border-orange-500 focus:outline-none"
                        />
                      ))}
                    </div>
              ...
              <>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-slate-200 rounded-xl px-4 py-3 focus:border-blue-500 focus:outline-none"
                    disabled={emailSent}
                  />
                </div>
                ...
                {!emailSent ? (
                  ...
                  <div className="text-center">
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-4">
                      ...
                      <p className="text-xs text-blue-600 mt-1">{t('auth.link.click')}</p>
                      <p className="text-xs text-blue-500 mt-2">⏱️ {t('auth.link.valid')}</p>
                    </div>
          ...
          <div>
            ...
            {!showCalculator && (
              <button
                ...
                className="w-full mb-4 border-2 border-dashed border-slate-300 rounded-xl p-3 text-center hover:border-orange-300 hover:bg-orange-50 transition-all"
              >
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-4">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-slate-200 rounded-lg px-4 py-2 focus:border-orange-500 focus:outline-none"
                  />
                </div>
                    ...
                    {calcDeductions.map((deduction, index) => (
                      <div key={index} className="flex gap-2">
                        <input
                          ...
                          className="flex-1 border-2 border-slate-200 rounded-lg px-3 py-2 text-sm focus:border-orange-500 focus:outline-none"
                        />
                        <input
                          type="number"
                          ...
                          placeholder="RM"
                          className="w-24 border-2 border-slate-200 rounded-lg px-3 py-2 text-sm focus:border-orange-500 focus:outline-none"
                        />
                ...
                {calcResult && (
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-2 rounded-lg font-medium"
                  >
        ...
        return (
          <div>
            ...
            <div className="flex gap-2 mt-6">
              ...
              <button
                onClick={() => setStep(6)}
                className="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-lg shadow-orange-500/30"
              >
        ...
        return (
          <div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-4">
              <p className="text-xs text-orange-600 mb-1">{t('summary.property')}</p>
              <p className="font-semibold text-orange-800">{propertyInfo.name}</p>
              <p className="text-sm text-orange-700">{propertyInfo.unit} • {propertyInfo.price}</p>
            </div>
        ...
        return (
          <div className="text-center">
            ...
            <div className="bg-slate-800 rounded-xl p-4 mb-4 text-left">
              <p className="text-orange-400 text-xs font-semibold mb-2">{t('result.next.title')}</p>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm text-white">
                  <span className="w-5 h-5 bg-orange-500 rounded-full flex items-center justify-center text-xs">1</span>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-lg shadow-orange-500/30"
            >
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 px-5 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-orange-400 text-xs font-mono">PRESCAN</span>
            </div>
          ...
          {step < 7 && (
            <div className="flex gap-1 mt-3">
              {[0,1,2,3,4,5,6].map(i => (
                <div key={i} className={`h-1 flex-1 rounded-full transition-all ${i <= step ? 'bg-orange-500' : 'bg-slate-700'}`} />
              ))}
            </div>
          )}
        </div>
