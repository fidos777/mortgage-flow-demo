...
export default function AdminMetricsPage() {
  ...
  // Funnel metrics
  const funnelSteps = [
    { key: 'LINK_CREATED', label: 'Link Created', icon: Link2, color: 'bg-blue-500' },
    ...
    { key: 'READINESS_CALCULATED', label: 'Readiness Calculated', icon: TrendingUp, color: 'bg-orange-500' },
