          ...
          <div className="space-y-4">
            ...
            {caseData.tacSchedule && (
              <div className="bg-orange-50 border border-orange-200 rounded-xl p-5">
                ...
                <p className="text-orange-700 font-medium">{caseData.tacSchedule.date}</p>
                <p className="text-orange-600">{caseData.tacSchedule.time}</p>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm space-y-2">
              <button className="w-full bg-orange-500 text-white py-2.5 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-orange-600 transition-colors">
